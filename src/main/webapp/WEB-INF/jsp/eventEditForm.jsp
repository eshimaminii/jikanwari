...
<body>
	...
	<div class="container">
		...
		<p>
			開始時： <input type="number" name="startHour" value="${event.startHour}"
				min="0" max="23" required /> 時 <input type="number"
				name="startMinute" value="${event.startMinute}" min="0" max="59"
				required /> 分
		</p>
